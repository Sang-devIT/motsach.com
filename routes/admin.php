...
Route::group(['prefix' => '/'],function(){
    ...
    Route::group(['prefix' => '/product'],function(){
        ...
        Route::post('{id}/update',[Admin\ProductsController::class,'update'])->name('admin.product.update');
    ...
    Route::group(['prefix' => '/category'],function(){
        ...
        Route::post('{id}/update',[Admin\CategorysController::class,'update'])->name('admin.category.update');
    ...
    Route::group(['prefix' => '/banner'],function(){
        ...
        Route::post('{id}/update',[Admin\BannersController::class,'update'])->name('admin.banner.update');
    ...
    Route::group(['prefix' => '/author'],function(){
        ...
        Route::post('{id}/update',[Admin\AuthorsController::class,'update'])->name('admin.author.update');
    ...
    Route::group(['prefix' => '/produce'],function(){
        ...
        Route::post('{id}/update',[Admin\ProducesController::class,'update'])->name('admin.produce.update');
