...
var temp = '<div class="form-group">\
                ...
                <div class="row">\
                    <div class="form-group col-lg-4">\
                        ...
                        <input type="number" name="data[quantity][]" class="form-control" placeholder="Nhập số lượng" value="{{ old('quantity') }}">\
                        <span style="color: red">@error('quantity'){{ 'Vui lòng nhập số lượng' }}@enderror</span>\
                    </div>\
                    <div class="form-group col-lg-4">\
                        <label>Giá bán</label>\
                        <div class="input-group">\
                            <input type="number" class="form-control format-price price text-sm" name="data[price][]" id="price" placeholder="Giá nhập" value="{{ old('price') }}">\
